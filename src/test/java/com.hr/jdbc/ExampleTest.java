...
import com.hr.JobId;
import com.hr.RepositoryException;
...
public class ExampleTest extends JdbcTest {
  // Sql
  ...
  Set<Employee> findAll() throws Exception {
  ...
  Set<Employee> findEmployeesByFirstName(String firstName) throws Exception {
    try {
  ...
  void persist(Employee employee) throws Exception {
    try (Connection connection = getConnection();
  ...
  void changePhoneNumber(int id, String newPhoneNumber) throws Exception {
